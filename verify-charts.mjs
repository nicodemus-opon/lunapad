...
const sql =
	"SELECT 'Jan' AS month, 'A' AS grp, 10 AS val UNION ALL SELECT 'Feb','A',25 UNION ALL SELECT 'Mar','A',15 UNION ALL SELECT 'Jan','B',30 UNION ALL SELECT 'Feb','B',22 UNION ALL SELECT 'Mar','B',40";
