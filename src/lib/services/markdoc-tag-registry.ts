...
export const MARKDOC_TAG_REGISTRY = {
	...
	video: { kind: 'leaf', selfClosing: true, runtime: 'custom' },
	embed: { kind: 'leaf', selfClosing: true, runtime: 'custom' },
	bookmark: { kind: 'leaf', selfClosing: true, runtime: 'custom' },
	math: { kind: 'leaf', selfClosing: true, runtime: 'custom' },
	toc: { kind: 'leaf', selfClosing: true, runtime: 'custom' },
