<script lang="ts">
	...
	const iconMap: Record<string, Component> = {
		...
		'control-text-input': TextCursorInput,
		'control-number-input': Sigma,
		'control-slider': ChevronsDownUp,
		'control-date-input': CalendarDays,
		'control-date-range': CalendarDays,
		'control-checkbox': ListChecks,
		'control-select': Filter,
		'control-multiselect': ListChecks,
		'control-run-button': MousePointerClick,
		'control-file-upload': Image,
		'control-table-input': Table2,
		'control-table-display': Table2,
		'control-pivot': Workflow,
		'control-map': MapPinned,
		'control-single-value': Gauge,
		'control-writeback': CreditCard,
