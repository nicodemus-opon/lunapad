	...
	export const badgeVariants = tv({
		...
		variants: {
			variant: {
				...
				neutral:
					'border-border/30 bg-muted/10 text-muted-foreground [a]:hover:bg-muted/20 [a]:hover:text-foreground',
				primary: 'border-primary/30 bg-primary/10 text-primary [a]:hover:bg-primary/20',
