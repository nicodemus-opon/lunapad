...
import { getJob } from '$lib/server/git-runner';

/**
 * SSE endpoint that streams live log output for a running git job (push/pull/fetch).
 * Subscribe with: GET /api/git/logs?jobId=<id>
 * Events: data: {"type":"line","text":"..."} / data: {"type":"done","exitCode":0}
 */
